...
#define MXWechatAPPID       @"wxc8cffdde73682f6b"
// 开放平台登录https://open.weixin.qq.com的开发者中心获取AppSecret。
#define MXWechatAPPSecret   @"fea4338269d6675af018200ed59f7dc7"
// 微信支付商户号
#define MXWechatMCHID       @"1425628002"
// 安全校验码（MD5）密钥，商户平台登录账户和密码登录http://pay.weixin.qq.com
// 平台设置的“API密钥”，为了安全，请设置为以数字和字母组成的32字符串。
#define MXWechatPartnerKey  @"YTKFEVCWEKLY053ZKNSJ69E40Q0TA54X"
