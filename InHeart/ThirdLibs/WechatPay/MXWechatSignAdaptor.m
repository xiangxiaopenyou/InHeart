                          ...
                          tradeType:(NSString *)tradeType
{
    if (self = [super init]) {
        ...
        _wechatAppId        = wechatAppId;              //appId
        _wechatMCHId        = wechatMCHId;              //商户ID
        _tradeNo            = tradeNo;                  //随机字符串
        _wechatPartnerKey   = wechatPartnerKey;         //商户秘钥
        _payTitle           = payTitle;                 //"支付"
        _orderNo            = orderNo;                  //订单号
        _totalFee           = totalFee;                 //价格
        _deviceIp           = deviceIp;                 //IP地址
        _notifyUrl          = notifyUrl;                //随意网址
        _tradeType          = tradeType;                //APP
